    ...
    >
      ...
      >
        ...
        <VStack align="flex-start" color="#EEE2E2" height="299px" width="68vw">
          ...
          <div></div>
          <text>
            STOOLEY’S Bar and Grill serves popular Canadian cuisine, handcrafted
            cocktails and service par excellence in a relaxed restaurant
            atmosphere. The well-stacked bar boasts of a wide selection of
            domestic and imported beers, wines, spirits and our exclusive house
            cocktails.
          </text>
          <div></div>

          <text>
            Set up over 30 years ago by a young entrepreneur with a passion for
            food and drinks the culinary tradition continues in Kingston the
            “Limestone city” on Lake Ontario. Located a short walk away from the
